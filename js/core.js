...
function summon(pool)
{
  ...
  /*  else if (rand >= 0.80 && rand < 0.98)
    {
        // SSR Craft Essence 4%
        var r = (rand - 0.80) / 0.18;
   ...
   /* else if (rand >= 0.92 && rand < 0.95)
    ...
    else
    {
        ...
        var upcards = pool.craft_essence_sr_up;
        var nmcards = pool.craft_essence_sr;
        card = summonFromPool(upcards, nmcards, "craft_essence", 3, sr);
    }
    return card;
}
